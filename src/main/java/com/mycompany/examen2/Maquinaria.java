...
import static com.mycompany.examen2.Maquinaria.main;
import org.bson.Document;
...
public class Maquinaria extends javax.swing.JFrame {
    ...
    public Maquinaria() {
        ...
        this.modelMaquinaria.addColumn("Id maquinaria");
   ...
   private void agregarRegistrosTabla(Document fila){
       ...
       String nombre = fila.get("Modelo").toString();
       String marca=fila.get("Marca").toString();
       this.modelMaquinaria.addRow(new Object[]{id,nombre,marca});
 }

    public void insertarDatos(){
       Document datosObj = new Document("_id",new ObjectId())
            .append("Id Maquinaria ",txtID.getText().toString())
